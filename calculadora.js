var valorAntigoTela = ""; // o que foi mostrado na tela antes de escolher a operação
var valorTela = ""; //o que está sendo mostrado na tela no momento
var acaoEscolhida; //a ação escolhida
...
function rodarAcao(acao)
{
    if (acao === "=")
    {
        ...
        if (acaoEscolhida === "/") 
        {
            resultado =  resultado = parseInt(valorAntigoTela) / parseInt(valorTela);
        }
        ...
        valorAntigoTela = "" // apenas depois da primeira conta
        return
    }
